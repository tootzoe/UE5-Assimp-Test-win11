...
void UAINode::Setup(aiNode* InNode, UAIScene* Scene, const aiMatrix4x4& ParentTransform)
{
    ...
    //WorldTransform = UAssimpFunctionLibrary::aiMatToTransform(MyTransform);  // tootzoe
...
{
     Transform = UAssimpFunctionLibrary::aiMatToTransform(Node->mTransformation);  //tootzoe
}
