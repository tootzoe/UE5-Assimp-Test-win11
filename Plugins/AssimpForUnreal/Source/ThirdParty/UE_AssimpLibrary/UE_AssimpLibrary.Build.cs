...
public class UE_AssimpLibrary : ModuleRules
{
	...
	public UE_AssimpLibrary(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
            ...
            PublicDelayLoadDLLs.Add(Path.Combine(ModuleDirectory, "assimp", "bin", "assimp-vc143-mt.dll"));
			...
			// Ensure that the DLL is staged along with the executable
              RuntimeDependencies.Add("$(PluginDir)/AssimpForUnreal/Source/ThirdParty/UE_AssimpLibrary/assimp/bin/assimp-vc143-mt.dll");
		}
